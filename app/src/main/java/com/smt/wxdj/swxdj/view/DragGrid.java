...
import com.smt.wxdj.swxdj.utils.DataTools;
		...
		if (dragImageView != null && dragPosition != AdapterView.INVALID_POSITION) {
			...
			switch (ev.getAction()) {
				...
				case MotionEvent.ACTION_MOVE:
					//ev.getRawX() 相对屏幕的X坐标 ----- ev.getX() 相对控件widget 自身的X坐标
...
//				itemHeight = dragViewGroup.getHeight();//获取该选中的View的高
//				itemWidth = dragViewGroup.getWidth();//获取该选中的View的宽
//				itemTotalCount = DragGrid.this.getCount();//获取目前GridView 总条数
