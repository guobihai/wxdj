...
public class DesUtils {
    ...
    */
    public static String strEnc(String data,String firstKey,String secondKey,String thirdKey){
        ...
        String encData = "";
        int[][] firstKeyBt = new int[256][256],secondKeyBt = new int[256][256],thirdKeyBt = new int[256][256];
        int firstLength = 0,secondLength = 0,thirdLength = 0;
        if(firstKey != null && firstKey != ""){
            firstKeyBt = getKeyBytes(firstKey);
//            firstLength = firstKeyBt[0].length;
            firstLength = firstKey.length();
            System.out.println("firstLength:"+firstLength);
        }
        if(secondKey != null && secondKey != ""){
            secondKeyBt = getKeyBytes(secondKey);
            secondLength = secondKey.length();
        }
        if(thirdKey != null && thirdKey != ""){
            thirdKeyBt = getKeyBytes(thirdKey);
            thirdLength = thirdKey.length();
        }

        if(leng > 0){
            if(leng < 4){
                int[] bt = strToBt(data);
                int[] encByte = new int[256];
    ...
    */
    private static String strDec(String data,String firstKey,String secondKey,String thirdKey){
        ...
        if(secondKey != null && secondKey != ""){
            secondKeyBt = getKeyBytes(secondKey);
            secondLength = secondKeyBt[0].length;
        }
        if(thirdKey != null && thirdKey != ""){
            thirdKeyBt = getKeyBytes(thirdKey);
            thirdLength = thirdKeyBt[0].length;
        }
