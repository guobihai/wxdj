...
public final class DateUtils {
    ...
    public static final String TYPE_ALL = "yyyy-MM-dd E hh:mm"; //年、月、日、星期、时、分
    public static final String TYPE_YMDHM = "yyyy-MM-dd HH:mm"; //年、月、日、时、分
    public static final String TYPE_YMDH = "yyyy-MM-dd hh"; //年、月、日、时
    public static final String TYPE_YMD = "yyyy-MM-dd";//年、月、日
    public static final String TYPE_HM = "hh:mm";//时、分
